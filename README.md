# USmorph_2.0
## 1. Introduction
`USmorph_2.0` is an upgraded version of USmorph. Compared to the original version, `USmorph_2.0` employs a two-step feature extraction method, which involves using a pre-trained model to perform preliminary feature extraction on images, followed by dimensionality reduction algorithms to compress the feature dimensions. Features obtained through this two-step process better characterize the morphology of galaxies. Specifically, during the unsupervised clustering process, compared to the 100 clusters in USmorph, this version achieves a smaller number of clusters (around 16) while simultaneously improving metrics such as label accuracy, recall, and F1 score. This reduces the time required for manual visual inspection and minimizes errors caused by inspecting multiple clusters. For more details on `USmorph_2.0`, please cite [Fang et al. 2025](https://doi.org/10.1051/0004-6361/202451734), [Yin et al. 2025](https://doi.org/10.1051/0004-6361/202555584), [Fang et al. 2026a](https://iopscience.iop.org/article/10.3847/1538-3881/ae2324) [Fang et al. 2026b](in preparation)
